...
proc main() =
  ...
  for line in lines:
    if line != "\n" and line != "":
      let
        a = line.toRunes[0]
        b = line.toNewCharForms.toRunes[2]
      if a != b:
        echo a, b
